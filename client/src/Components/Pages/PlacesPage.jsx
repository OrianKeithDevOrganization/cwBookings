            ...
            {action === 'new' && (
                <div>
                    <form>
                        ...
                        <p className="text-gray-500 text-sm">Title for place should be catchy and short</p>
                        <input type="text" placeholder="title for example: Speke Apartment" />
                        ...
                        <p className="text-gray-500 text-sm"> description of the property</p>
                        <textarea /> 
                        ...
                        <p className="text-gray-500 text-sm"> Add check in and Check out time </p>
